...
'sum': 'Сумма',
    ...
    'is_opening_balance': 'Начальный остаток',
    'driver': 'Водитель',
    'culprit': 'Виновник',
    'damage_amount': 'Ущерб',
    'detected_date': 'Дата обнаружения',
    'invoice_date': 'Дата счёта',
    'doc_type': 'Тип документа',
    'doc_num': 'Номер документа',
    'repair_type': 'Тип ремонта',
    'return_type': 'Тип возврата',
    'is_manual_price': 'Цена вручную',
    'purchase_price': 'Цена закупки',
    'retail_price': 'Розничная цена',
    'markup_percent': 'Наценка, %',
    'discount_percent': 'Процент скидки',
    'discount_part_id': 'Запчасть со скидкой',
    'final_unit_price': 'Итоговая цена за ед.',
    'qty': 'Количество',
    'unit': 'Ед. изм.',
    'code': 'Код',
    'artikul': 'Артикул',
    ...
    'regex_pattern': 'Паттерн (Regex)',
    'error_text': 'Текст ошибки',
    'title': 'Название',
    'type_id': 'Тип',
    'type_sklad_id': 'Тип склада'
};
